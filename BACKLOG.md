...
| **6.5** | **Notifications that arrive**: Phase 2's Web Push, native push through Expo on the same table, per-kind toggles, and the permission asked at the right moment — T-089 · **done** on the web; native in build 5, in Play review since 19 September (T-107) | L | — |
