...
| ~~A megosztókártya csak webes~~ **kész** | A `react-native-view-shot` és az `expo-sharing` bekerült, a kártya natív nézetekből épül ugyanabból a specifikációból, amiből a canvas olvas, és két formátuma van — négyzet és 9:16-os story (T-009, T-108). Mindkettő natív modul, így a telefonokra a következő production builddel jut el, nem OTA-val. |
