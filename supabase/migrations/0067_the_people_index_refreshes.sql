...
--
-- Nothing user-stored changes. Applied to the project when written, on
-- 12 September 2026, as the file then numbered 0059. It sat on an unmerged
-- branch while 0059 through 0066 landed on main under other names, so it is
-- renumbered here rather than renumbering eight applied files; re-running
-- it is a no-op, since the function body below is what the project holds.
