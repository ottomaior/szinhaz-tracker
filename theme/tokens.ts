...
/**
 * Values the primitives carried on 22 September 2026, named so that the
 * consolidation commit of the Velvet Curtain finish pass could reach zero
 * literals without moving a pixel. Every entry is retired by the primitive
 * convergence commit that follows it (D.0c in the plan): when this object is
 * empty it is deleted. Nothing new may reference it.
 */
export const legacy = {
  buttonRadius: 12,
  ...
  headerChipPaddingVertical: 7,
  headerChipPaddingLeft: 12,
  headerChipMinHeight: 36,
  dateChipPaddingVertical: 9,
  badgeGap: 5,
  badgePaddingVertical: 3,
  badgePaddingHorizontal: 9,
  badgeSmallGap: 4,
  badgeSmallPaddingVertical: 2,
  badgeSmallPaddingHorizontal: 7,
  pillTabsPadding: 3,
  pillTabsGap: 2,
  pillTabsPaddingHorizontal: 14,
  programRowPaddingVertical: 10,
  programRowLeadGap: 6,
  programRowBodyGap: 8,
  programRowWeekdayNudge: -2,
  listCardOverlap: -22,
  stackGap3: 3,
  stackGap1: 1,
  stepperDisc: 30,
  stepperGap: 8,
  thickHairline: 1.5,
  followButtonPaddingVertical: 8,
  followButtonPaddingHorizontal: 14,
  sendButtonPaddingHorizontal: 16,
  inputPadding12: 12,
  topBarButtonPaddingVertical: 8,
  signedOutIconNudge: 2,
  sheetCloseIcon: 17,
  frameRadius: 3,
  toastCloseHitSlop: 10,
} as const;
